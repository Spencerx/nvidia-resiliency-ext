...
"""Service-layer configuration for nvidia_resiliency_ext.services.attrsvc HTTP service.
...
#   from nvidia_resiliency_ext.services.attrsvc.config import ErrorCode
...
from nvidia_resiliency_ext.attribution.orchestration.config import ErrorCode as ErrorCode
